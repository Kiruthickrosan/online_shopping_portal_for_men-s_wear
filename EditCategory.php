...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" height="209" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="33" bgcolor="grey"><span class="style10 style11 style12">Edit Record</span></td>
      </tr>
      <tr>
        <td><?php
$Id=$_GET['CatId'];
...
?>
            <form method="post" action="UpdateCategory.php">
              <table width="100%" border="0">
                <tr>
                  <td height="70"><span class="style8">Category Id:</span></td>
                ...
                <tr>
                  <td height="70"><span class="style8">Category Name:</span></td>
                ...
                <tr>
                  <td height="70"><span class="style8">Description:</span></td>
                ...
                <tr>
                  <td></td>
                  <td height="70"><input type="submit" name="submit" value="Update Record" /></td>
                </tr>
</table>
            </form>
            <?php
