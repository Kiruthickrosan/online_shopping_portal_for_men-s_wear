...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:tomato">New User Registration</span></h2>
    ...
    <form action="insert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" name="form2" id="form2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="40"><div align="left">Customer Name:</div></td>
        ...
        <tr>
          <td height="40"><div align="left">City:</div></td>
          <td><label>
