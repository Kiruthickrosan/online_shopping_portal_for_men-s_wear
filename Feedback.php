...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:tomato"> Feedback From Customers</span></h2>
    <table width="100%" border="1" bordercolor="#003300" >
      <tr>
        <th height="32" bgcolor="#BDE0A8" class="style3"><div align="center" class="style9 style5"><strong>Id</strong></div></th>
        <th bgcolor="#BDE0A8" class="style3"><div align="center" class="style9 style5"><strong>Customer Name</strong></div></th>
        <th bgcolor="#BDE0A8" class="style3"><div align="center" class="style9 style5"><strong>Feedback</strong></div></th>
        <th bgcolor="#BDE0A8" class="style3"><div align="center" class="style9 style5"><strong>Date</strong></div></th>
         <th bgcolor="#BDE0A8" class="style3"><div align="center" class="style9">Delete</div></th>
      </tr>
      <?php
